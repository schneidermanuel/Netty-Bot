...
internal class YoutubeNotificationBusinessLogic : IYoutubeNotificationBusinessLogic
{
    private readonly IYoutubeNotificationRepository _repository;

    public YoutubeNotificationBusinessLogic(IYoutubeNotificationRepository repository)
    {
