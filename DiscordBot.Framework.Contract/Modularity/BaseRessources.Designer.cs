...
namespace DiscordBot.Framework.Contract.Modularity {
    ...
    internal class BaseRessources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Kann nur auf einem Server ausgeführt werden.
        /// </summary>
        internal static string Error_NotAGuild {
            get {
                return ResourceManager.GetString("Error_NotAGuild", resourceCulture);
            }
        }
